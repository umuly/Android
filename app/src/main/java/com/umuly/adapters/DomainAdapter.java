...
public class DomainAdapter extends BaseAdapter {
    private List<DomainListResponseObject> list;
    private Context context;
    private LayoutInflater layoutInflater;

    public DomainAdapter(List<DomainListResponseObject> list, Context context) {
        this.list = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        title.setText(list.get(position).getDomainUrl());
        return convertView;
    }
